...
import * as S from "@/pages/Main/MainComponents/NewQuoteStyled";
...
const [selectedIds, setSelectedIds] = useState<number[]>([]);
    const friends = [
    { id: 1, username: "라라진", intro: "Seize the day", profileImgUrl: "https://picsum.photos/200" },
    { id: 2, username: "듀랄라", intro: "Positive Thinking", profileImgUrl: "https://picsum.photos/200" },
    { id: 3, username: "어푸", intro: "작심삼일의 권위자", profileImgUrl: "https://picsum.photos/200" },
    { id: 4, username: "스페이스", intro: "hola", profileImgUrl: "https://picsum.photos/200" },
    ];
    ...
    return (
        <S.Container>
                ...
                <S.SelectBtn onClick={()=>navigate("/main-home")}>명언 남기기</S.SelectBtn>
